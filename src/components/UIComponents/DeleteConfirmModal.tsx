  ...
  return (
    <>
      ...
      <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-50 w-full max-w-lg transition-opacity duration-300">
        <div className="bg-(--bg-surface) rounded-none shadow-2xl border border-(--border-primary) p-8">
          ...
          <div className="flex gap-4">
            <button
              ...
              onClick={onClose}
              disabled={isLoading}
              className="flex-1 px-6 py-3 bg-(--bg-surface) border border-(--text-secondary) text-(--text-primary) rounded-none hover:border-(--text-primary) hover:bg-(--bg-secondary) transition-colors font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {t("delete.cancel")}
            </button>
            <button
              ...
              onClick={onConfirm}
              disabled={isLoading}
              className="flex-1 px-6 py-3 bg-(--accent-primary) text-(--text-inverted) rounded-none hover:bg-(--accent-hover) transition-colors font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
            >
