  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6 lg:gap-8 mb-8 lg:mb-10">
        ...
        >
          <h2
            className="text-lg sm:text-xl font-bold mb-4 sm:mb-6 lg:mb-8"
            style={{ color: "var(--text-primary)" }}
          >
              ...
              <div className="flex items-center gap-3 mb-3">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-xs" style={{ color: "var(--text-secondary)" }}>
                    {activeGoal.formatted_progress.current} / {activeGoal.formatted_progress.target}
                  </p>
                </div>
              </div>
              <ProgressBar
                label=""
                value={activeGoal.current_amount}
                max={activeGoal.target_amount}
